...
public class Medium {
    ...
    public void play() {
        animate.animateText("You have selected MEDIUM difficulty", 25);
        animate.animateText("Number range is from 0 to 50", 25);
        animate.animateText("You have 5 guesses", 25);
        while(App.state){
            
            this.correct = new Random().nextInt(0,50);
